        ...
        $routeProvider
                ...
                .when('/services',
                        {controller: 'ServicesController',
                            templateUrl: 'partials/services/home.html'})
                .when('/services/:id',
                        {controller: 'ServiceDetailsController',
                            templateUrl: 'partials/services/details.html'})
                .when('/services/:id/:type',
                        {controller: 'ServiceDetailsTypeController',
                            templateUrl: 'partials/services/details.html'});
