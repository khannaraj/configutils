...
/**
 * This class intialize the web config for Application configuration utility
 * 
 * @author rkhanna
 * @since V 1.0
 * @version 1.0
...
public class WebConfig extends SpringDataWebConfiguration {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        logger.debug("Application Resources Loaded");
    }

    @Override
    public void addViewControllers(ViewControllerRegistry registry) {
    	/*
    	 * View Controller will be added later in the project.
    	 */
    }
